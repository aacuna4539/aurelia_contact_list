...
define('contact-list',['exports', './web-api', 'aurelia-framework', './messages', 'aurelia-event-aggregator'], function (exports, _webApi, _aureliaFramework, _messages, _aureliaEventAggregator) {
  'use strict';
